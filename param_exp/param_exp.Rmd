...
myLHS <- LHS(
  ...
  N = 20, # size of hypercube = number of samples generated 
...
# Time difference of 5.935406 mins
start_time <- Sys.time()
LHS2 <- LHS(rev_mod, N = 20, factors = factors, 
            repetitions = 5, nboot = 10, 
            q = q, q.arg = q.arg,
            res.names = res.names)
end_time <- Sys.time()
end_time - start_time
...
If the global cv is far greater than all of the pointwise cvs, this means that
