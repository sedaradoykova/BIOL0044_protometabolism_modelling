...
| $CO_{2},\ H_{2}$ | $CO,\ H_{2}$ | $k_{5}*CO_{2}*H_{2}$ | $k_{5} = 0.061$ |
...
#        file = paste0("lia_sim_tab.png"), width = 30, height = 20, units = "cm")
```
...
#                   label = list(table), vjust = 0.45, hjust = 0.5),
#        file = paste0("rev_sim_neg.png"), width = 30, height = 20, units = "cm")
```
...
#        file = paste0("rev_sim_works.png"), width = 25, height = 17, units = "cm")
# ggsave(fig,
#        file = paste0("rev_sim_works1.png"), width = 18, height = 13, units = "cm")
```
...
```{r out.width="50%"}
knitr::include_graphics("network_vis.png")
knitr::include_graphics("netw_plt_ppt.png")
```
...
ggsave((ggplot() +  theme_void() + 
         ...
         all_react,
       file = paste0("rev_sim_oneplot.png"), width = 20, height = 8, units = "cm")
```
...
```{r out.width="75%"}
knitr::include_graphics("lia_sim_tab.png")
```

```{r out.width="75%"}
knitr::include_graphics("rev_sim_neg.png")
```

```{r out.width="75%"}
knitr::include_graphics("rev_sim_works.png")
```